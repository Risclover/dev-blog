...
Create all of these files and folders before we move on. As you create each file, take a moment to create the React function and its container div, like so:
