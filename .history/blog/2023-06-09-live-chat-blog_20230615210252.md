...
I used [react-icons](https://react-icons.github.io/react-icons) library to find the icon I needed (re: chat bubble with 3 dots inside), went into my `NavBar` component, and created the button.
