...
Create all of these files and folders before we move on. As you create each file, take a moment to create the React function and its container div. As an example, here is how you'd do it with the Chat file:

```javascript
// Chat.js

import React from 'react';
import ChatLeft from "./
const Chat = () => {
