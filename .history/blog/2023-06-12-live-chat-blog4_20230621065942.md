...
<p style={{textDecoration: "underline", color: "red"}}><a style={{color: "red"}} href="http://localhost:3000/blog/live-chat-feature-pt3">Cloning Reddit's Live Chat Feature Pt. 4: Frontend</a></p>
