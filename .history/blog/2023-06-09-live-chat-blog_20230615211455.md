...
This is just something to keep in mind when we work on the button's functionality.
...
2. Inside of the button is the tooltip itself:
   ...
   So, when the `showTooltip` state variable is `true`, the tooltip, which says "Chat", appears.
