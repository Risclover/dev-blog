...
It's hard to manually test a feature if it doesn't exist physically, so we need to set up some basic styling including the chat window's layout, the general size of each component, 
