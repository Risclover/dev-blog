...
Next, we create a new file, `socket.py`, which lives in the general `app/` folder instead of `api/`. Here, we handle the remainder of the backend code needed to implement WebSockets.
