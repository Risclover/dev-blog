...
We create a new file, `socket.py`, which lives in the general `app/` folder instead of `api/`. In this file, we handle the entirety of the code needed to implement WebSockets.
