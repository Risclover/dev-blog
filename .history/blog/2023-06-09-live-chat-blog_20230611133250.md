...
Next, we have the `ChatThread` model to represent a chat thread between two users. The only information required is the thread id and the user ids of the participants. 
