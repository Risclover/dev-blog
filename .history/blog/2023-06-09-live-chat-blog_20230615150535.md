...
Locating an icon that looked like the one on Reddit was a little difficult. None seemed to exist on my usual source for icons, [React-Icons](https://react-icons.github.io/react-icons/). Eventually, I went onto [The Noun Project](https://thenounproject.com) and found one that looked really close. (I typically don't like to do this, because it requires downloading the image instead of using )
