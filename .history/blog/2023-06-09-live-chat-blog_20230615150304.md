...
Locating an icon that looked like this was a little difficult. None seemed to exist on my usual source for icons, [React-Icons](https://react-icons.github.io). However, I did manage to find it on his icon on [Vector Icons](https://vectoricons.com).
