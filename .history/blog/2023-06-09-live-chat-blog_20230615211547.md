...
:::note Finding Icons
When it comes to finding an icon, I personally don't like to deviate from using the [react-icons](https://react-icons.github.io/react-icons/), because doing so usually requires downloading the image instead of importing it from a library and using it in the code, like you do with the icons from react-icons.
