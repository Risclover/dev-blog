...
Since we know that we're going to need two access points that are in two completely different components, we need to create the state variable in a place that can reach both components. For this 
