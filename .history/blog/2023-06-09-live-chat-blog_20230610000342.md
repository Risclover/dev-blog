...
However, we aren't done yet. Remember the association table we created earlier? This is where we make sure to associate the table to this model. We also add `lazy
