...
:::note Finding Icons
When it comes to finding an icon, I personally don't like to deviate from using the [react-icons](https://react-icons.github.io/react-icons/) library, because doing so typically requires downloading the image instead of importing it from a library and using it in the code.
