...
:::note
Just as an FYI, I typically don't like to deviate from finding icons on React-Icons, because , because it requires downloading the image instead of importing it from a
library and using it in your code.
:::
