...
Note that the import statement at the top of some of the code snippets in this blog post (") is referring to the following code, which lives in a separate file called `db.py`:
