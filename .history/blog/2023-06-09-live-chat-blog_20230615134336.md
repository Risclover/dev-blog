...
:::info
The font-family used above is known as a **native font stack** or **system font stack**. It essentially uses the operating system's default system font, accounting for all of the major operating systems used today (such as ios, Windows,)
