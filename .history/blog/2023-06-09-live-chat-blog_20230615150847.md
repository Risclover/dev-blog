...
:::note
Just as an FYI, I typically don't like to deviate from finding icons on [React-Icons](https://react-icons.github.io/react-icons/), because doing so typically requires downloading the image instead of importing it from a library and using it in the code, like you do with React-Icons icons.
