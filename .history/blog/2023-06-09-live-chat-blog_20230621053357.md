...
Please note that this blog post assumes a basic understanding of most of the languages and technologies used in the project, which include React, Redux, Flask, SQLAlchemy, and React-Router. The project also uses flask-socketio for the 
