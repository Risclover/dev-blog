...
With our chat threads sorted by latest message sent, we set the selected chat to the first item in the list, which will be the top thread in the chat navigation. 
