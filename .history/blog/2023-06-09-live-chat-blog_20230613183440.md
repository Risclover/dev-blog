...
Create all of these files and folders before we move on.

Next, we may as well "initialize" our files, so to speak. Let's go through every single one and check on them, 
