...
On Reddit, there are two ways to access Chat - via a button in the top navbar, and via the 'Chat' button on user profile pages.
...
<figcaption><em>The chat button located in the top navbar</em></figcaption>

</figure>

<figure>

![](../profile-chat-btn.png)

<figcaption><em>The chat button located on a user's profile page</em></figcaption>
